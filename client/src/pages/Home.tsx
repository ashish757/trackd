            ...
            <div className="container py-8">
                ...
                <div className="mt-12 mb-10">
                    <h1 className="text-4xl font-bold text-text-primary mb-3">
                        Welcome back, <span className={`text-primary-color`}> {user?.name} 👋</span>
                    </h1>
                    <p className="text-text-secondary text-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                    ...
                    {tabs.map((tab, index) => {
                        ...
                        return (
                            <div key={tab.id}
                                className={`${style.card} text-center transition-all duration-300 ${ isActive  ? style.active : '' }`}
                                onClick={() => setActiveTab(tab.id as 'all' | 'watching' | 'completed' | 'plan')}
                                style={{ animationDelay: `${index * 0.3}s`, animation: 'fadeIn 0.6s ease-out forwards', opacity: 0, }}>

                                <div className={`${style.icon} flex items-center justify-center mx-auto mb-4`}>
                                    <Icon className={`h-8 w-8 icon`} />
                                </div>
                                <div className={`${style.count} count text-4xl font-bold mb-2`}>
                                    {tab.count}
                                </div>
                    ...
                    <div className="max-w-2xl mx-auto">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`${style.searchBox} w-full`}
                            />
                        </div>
                    </div>
                </div>
