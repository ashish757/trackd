...
function SigninPage() {
    ...
    return (
        <div className="min-h-screen bg-white md:bg-gradient-to-br md:from-purple-50 md:via-white md:to-indigo-50 md:flex md:items-center md:justify-center md:px-4 md:py-12">
