 ...
 * @returns HTML email content
 */
export const verifyChangeEmailTemplate = (name: string, link: string): string => {
    const content = `
        <div class="email-body">
...
/**
 * Email change request notification template
 * @param name - User's name
 * @param newEmail - New email address
 * @returns HTML email content
 */
export const changeEmailRequestTemplate = (name: string, newEmail: string): string => {
    const content = `
        <div class="email-body">
...
/**
 * Email successfully changed template
 * @param name - User's name
 * @param newEmail - New email address
 * @returns HTML email content
 */
export const emailChangedSuccessTemplate = (name: string, newEmail: string): string => {
    const content = `
        <div class="email-body">
